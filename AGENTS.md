...
This guidance is for coding agents (Codex, and any agent that reads AGENTS.md) connected to an
Embabel appliance over MCP. The server named `embabel` IS the appliance: a world runtime holding
