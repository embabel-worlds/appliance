...
function chosenTheme(settings: Settings) {
 ...
 */
async function applyTheme(settings: Settings, name: string) {
 ...
 */
async function restoreTheme(settings: Settings) {
...
export { applyTheme, restoreTheme, chosenTheme }
