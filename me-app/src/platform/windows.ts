...
//   - Browser history → the schema is identical and common.ts already handles
...
/** No sqlite3 ships with Windows; see the header note. */
const SQLITE: string | null = null

export const windows: SensorPlatform = {
  id: 'windows',
  displayName: 'Windows',
